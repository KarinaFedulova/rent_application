...
import 'package:rent_application/widgest/custom_snacBar.dart';
...
class _AuthScreenState extends State<AuthScreen> {
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: const UnderlineInputBorder(
                    borderSide: BorderSide(color: const Color(0xFFC5CEE0)),
                  ),
  ...
  Widget phoneForm() {
    ...
    return Column(
      children: [
        const Text('Добро пожаловать', style: TextStyle(fontSize: 14)),
        const SizedBox(
          height: 9,
        ),
        Container(
